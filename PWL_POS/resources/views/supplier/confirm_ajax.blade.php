        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table table-sm table-bordered table-striped">
                    <tr><th class="text-right col-3">Supplier Name :</th><td class="col-9">{{ $supplier->supplier_nama }}</td></tr>
                    <tr><th class="text-right col-3">Supplier Contact :</th><td class="col-9">{{ $supplier->supplier_kontak }}</td></tr>
                    <tr><th class="text-right col-3">Supplier Address :</th><td class="col-9">{{ $supplier->supplier_alamat }}</td></tr>
                </table>
            </div>
